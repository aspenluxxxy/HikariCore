...
static cl::opt<int> ObfTimes("sub_loop", cl::desc("Choose how many time the -sub pass loops on a function"),
							 cl::value_desc("number of times"), cl::init(1), cl::Optional);
static cl::opt<unsigned int> ObfProbRate("sub_prob",
...
struct Substitution : public FunctionPass {
	...
	bool flag;
	Substitution(bool flag) : Substitution() {
		this->flag = flag;
	}
...
FunctionPass* llvm::createSubstitutionPass() {
